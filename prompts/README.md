...
- `SCLATENT_CC_AUDIT_AND_GOAL_PROMPT.md`: ask Cursor/CC to understand scLatent,
  audit documents/results, and propose concrete next directions.
- `CODEX_SCLATENT_COORDINATOR_PROMPT.md`: ask a Codex session to resume
  scLatent coordination.
