...
TARGET_TIME="2026-06-27 03:35:00"
DOWNLOAD_RUN="${ROOT}/runs/latentfm_external_depmap_24q4_sources_download_20260627"
INSPECT_RUN="${ROOT}/runs/latentfm_external_depmap_24q4_source_inspect_20260627"
INSPECT_SCRIPT="${ROOT}/ops/inspect_latentfm_depmap_24q4_sources_20260627.py"
