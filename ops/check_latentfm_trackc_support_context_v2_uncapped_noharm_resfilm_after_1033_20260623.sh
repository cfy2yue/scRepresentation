...
WINDOW_EPOCH=$(TZ=Asia/Shanghai date -d '2026-06-23 10:33:00' +%s)
NOW_EPOCH=$(TZ=Asia/Shanghai date +%s)
if (( NOW_EPOCH < WINDOW_EPOCH )); then
  echo "Refusing to check before 2026-06-23 10:33:00 CST; v2 uncapped no-harm posthoc is a long GPU task." >&2
  exit 3
fi
